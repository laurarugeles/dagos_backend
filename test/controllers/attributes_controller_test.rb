...
class AttributesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create attribute" do
    assert_difference('Attribute.count') do
      post attributes_url, params: { attribute: { attribute_description: @attribute.attribute_description, attribute_name: @attribute.attribute_name } }
    end
  ...
  test "should update attribute" do
    patch attribute_url(@attribute), params: { attribute: { attribute_description: @attribute.attribute_description, attribute_name: @attribute.attribute_name } }
